...
export const translations = {
  ...
  'meal.pageSubtitle':      { fr: 'Prends une photo de ton assiette pour obtenir un score santé, la liste des ingrédients et une estimation calorique.', ary: 'صور الطبق ديالك باش تشوف النقطة الصحية، المكونات، وتقدير السعرات.' },
  ...
  'meal.analyzingHint':     { fr: "Identification des ingrédients, estimation des calories et calcul du score. Ça prend 15 à 30 secondes.", ary: 'كيعرف المكونات، السعرات، والنقطة. كيخد من 15 لـ 30 ثانية.' },
